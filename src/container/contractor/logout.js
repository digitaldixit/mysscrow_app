...
import { contractorlogout } from './contractor_action';

class ContractorAccountLogout extends Component {

  componentWillMount() {
    this.props.contractorlogout();
  }
  render() {
    return (
      <div id="logout">
...
export default connect(null, { contractorlogout })(ContractorAccountLogout)
